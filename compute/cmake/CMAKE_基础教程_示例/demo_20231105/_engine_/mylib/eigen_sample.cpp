#include "eigen_sample.hpp"

Eigen_Sample::Eigen_Sample()
{
...
template <typename T>
using Vec2 = Matrix<T, 1, 2>;
template <typename T>
using Mat2 = Matrix<T, 2, 2>;

void Eigen_Sample::Eigen_Basic()
{
...
void Eigen_Sample::Eigen_Block_Operation()
{
    ...
    std::cout << "segment:" << std::endl
              << vec.segment(3, 3) << std::endl; // 4 5 6
    ...
    std::cout << "mat     " << std::endl
              << mat << std::endl;
    std::cout << "mat.col:" << std::endl
              << mat.col(3) << std::endl;
    std::cout << "mat.row:" << std::endl
              << mat.row(2) << std::endl;

    std::cout << "mat.block: " << std::endl
              << mat.block(1, 1, 2, 2) << std::endl; // 6 7 10 11
    std::cout << "mat.blockx:" << std::endl
              << mat.block<2, 2>(1, 1) << std::endl; // 6 7 10 11   num is in <>  location is in ()
}

void Eigen_Sample::Eigen_Calculate()
{
    ...
    std::cout << "mat1*mat2: " << std::endl
              << mat1 * mat2 << std::endl;
    std::cout << "mat1*0.5: " << std::endl
              << mat1 / 2 << std::endl;

    std::cout << "mat1.transpose: " << std::endl
              << mat1.transpose() << std::endl; // 转置
    std::cout << "mat1.conjugate: " << std::endl
              << mat1.conjugate() << std::endl; // 共轭 复数矩阵常用
    std::cout << "mat1.inverse: " << std::endl
              << mat1.inverse() << std::endl; // 逆矩阵
    std::cout << "mat1.adjoint: " << std::endl
              << mat1.adjoint() << std::endl; // 伴随矩阵
    std::cout << "mat1.determinant: " << std::endl
              << mat1.determinant() << std::endl; // 行列式
