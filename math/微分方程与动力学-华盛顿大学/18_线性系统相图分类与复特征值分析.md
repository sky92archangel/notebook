...
- **稳定性**：$\mathbf{x}=0$ 是**鞍点**，系统不稳定，典型于双足行走、行星动力学（）等平衡系统(拉格朗日点就是鞍点)

<img src="18_线性系统相图分类与复特征值分析.assets/image-20260301192956941.png" alt="image-20260301192956941" style="zoom:50%;" />

<img src="18_线性系统相图分类与复特征值分析.assets/image-20260301192620214.png" alt="image-20260301192620214" style="zoom:70%;" />
